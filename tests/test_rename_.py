...
class RenameTest(TestClient):
    ...
    def test_sqlite_update(self):
        ...
        rename_record = [i for i in action_log if i["id"] == 2][0]
        ...
        mkdir_record = [i for i in action_log if i["id"] == 3][0]
        self.assertEqual(rename_record["orig_name"], random_dir_name)
        self.assertEqual(rename_record["details"], 'Created directory "{}/'.format(random_name))
        ...
        import pdb;pdb.set_trace()
        self.assertEqual(len(action_log), 4)
        mkdir_record = [i for i in action_log if i["id"] == 4][0]
        self.assertEqual(rename_record["orig_name"], random_dir_name)
        self.assertEqual(rename_record["details"], 'Created directory "{}/'.format(random_name))
