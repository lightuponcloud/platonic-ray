...
class FargateAppWorkerServiceStack(core.Stack):
    def __init__(
        self,
        scope: Construct,
        construct_id: str,
        ...
        **kwargs,
        ...
        fargate_config = config.fargate_worker
        ...
        # Create a cluster
        cluster = ecs.Cluster(self, "fargate-app-worker-service", vpc=vpc)

        # Logging
        logging = ecs.AwsLogDriver(
            stream_prefix="AppWorkerServiceLogs",
            log_group=logs.LogGroup(
                self,
                "FargateAppWorkerServiceLogGroup",
                log_group_name=f"{config.stage_prefix}/WorkerService",
            ),
        )
